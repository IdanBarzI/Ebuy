...
namespace SqlData
{
    public partial class _1044_EEK1Context : DbContext
    {
        private readonly IConfiguration _configuration;
        //public _1044_EEK1Context(IConfiguration configuration)
        //{
        //    _configuration = configuration;
        //}

        public _1044_EEK1Context()
        {

        }

        public _1044_EEK1Context(DbContextOptions<_1044_EEK1Context> options)
            : base(options)
        {
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=199.203.75.61\\sqlsrv;Database=1044_EEK1;User Id=EEK1;Password=EEK1;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CasualCustomer>().ToTable("CasualCustomer");
